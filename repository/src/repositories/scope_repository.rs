...
impl IRepository<Scope> for ScopeRepository {
    ...
    async fn fn_repo_get_by_id_postgresql(id: i32) -> anyhow::Result<Scope> {
        // TODO: Implement PostgreSQL get by id logic
        Err(anyhow::anyhow!("Not implemented"))
    }

    async fn fn_repo_get_all_postgresql() -> anyhow::Result<Vec<Scope>> {
        // TODO: Implement PostgreSQL get all logic
        Err(anyhow::anyhow!("Not implemented"))
    }

    async fn fn_repo_create_postgresql(obj: Scope) -> anyhow::Result<Scope> {
        // TODO: Implement PostgreSQL create logic
        Err(anyhow::anyhow!("Not implemented"))
    }

    async fn fn_repo_update_postgresql(obj: Scope) -> anyhow::Result<Scope> {
