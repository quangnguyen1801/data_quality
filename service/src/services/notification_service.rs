...
use model::{modelviews::notification_view::NotificationView, shared::ultihelper::CONFIGS};
use repository::{
    repositories::notification_repository::NotificationRepository, shared::irepository::IRepository,
};

use crate::iservices::inotification_service::INotificationService;

pub struct NotificationService {}
#[async_trait]
impl INotificationService for NotificationService {
