...
impl IComparisonOpService for ComparisonOpService {
    async fn fn_ser_get_by_id(id: i32) -> anyhow::Result<ComparisonOpView> {
        ...
        let data = match dbtype.as_str() {
            ...
            "PostgreSql" => ComparisonOpRepository::fn_repo_get_by_id_postgresql(id).await?,
    ...
    async fn fn_ser_get_all() -> anyhow::Result<Vec<ComparisonOpView>> {
        ...
        let data = match dbtype.as_str() {
            ...
            "PostgreSql" => ComparisonOpRepository::fn_repo_get_all_postgresql().await?,
    ...
    async fn fn_ser_create(obj: ComparisonOpView) -> anyhow::Result<ComparisonOpView> {
        ...
        let result = match dbtype.as_str() {
            ...
            "PostgreSql" => ComparisonOpRepository::fn_repo_create_postgresql(data).await?,
    ...
    async fn fn_ser_update(obj: ComparisonOpView) -> anyhow::Result<ComparisonOpView> {
        ...
        let result = match dbtype.as_str() {
            ...
            "PostgreSql" => ComparisonOpRepository::fn_repo_update_postgresql(data).await?,
    ...
    async fn fn_ser_delete(id: i32) -> anyhow::Result<bool> {
        ...
        let result = match dbtype.as_str() {
            ...
            "PostgreSql" => ComparisonOpRepository::fn_repo_delete_postgresql(id).await?,
    ...
    async fn fn_ser_get_by_setting_version_id(
        ...
        let data = match dbtype.as_str() {
            "SQLServer" => {
                ComparisonOpRepository::fn_repo_get_by_setting_version_sqlserver(setting_version_id)
                    .await?
            }
            "PostgreSql" => {
                ComparisonOpRepository::fn_repo_get_by_setting_version_postgresql(
                    setting_version_id,
                )
                .await?
            }
